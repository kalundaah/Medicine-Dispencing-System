...
<body>
    <div id="navpane">
        ...
        <a href="reports.php" style="text-decoration: none; color:white;"><div class="elements" id="navprofile"><h5>Revenue</h5></div></a>
    ...
    <div id="con">
        <div id="enlarged">
            <div id="sidepane">
                ...
                <a href="medicine.php" style="text-decoration: none; color:white;"><div class="side-elements" id="stock"><div class="icons"><i class="fa-solid fa-tablets"></i></div><div class="text"><h5>Medicine</h5></div></div></a>
                <a href="patients.php" style="text-decoration: none; color:white;"><div class="side-elements" id="allocate"><div class="icons"><i class="fa-solid fa-mask-face"></i></div><div class="text"><h5>Patient</h5></div></div></a>
                <a href="reports.php" style="text-decoration: none; color:white;"><div class="side-elements" id="update"><div class="icons"><i class="fa-solid fa-money-bill"></i></div><div class="text"><h5>Revenue</h5></div></div></a>
            </div>
        </div>
