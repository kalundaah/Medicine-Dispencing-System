...
if(isset($_POST['submit']))
{
    ...
    if(array_filter($errors)){}
        ...
        $sql = "INSERT INTO doctor(firstname,lastname,age,email,password,phonenos) VALUES ('$fname','$lname','$dob','$pemail','$pp','$pph')";
        if(mysqli_query($conn,$sql)){
            $suc = 'DOCTOR CREATED SUCCESSFULLY';
...
<body>
    <div id="central">
        <h7> Create a doctor.</h7>

        <div class="errormessage" style="color:red; margin:100px,0;"><?php echo($suc);  ?></div>
        <!-- Form for creating new patient -->
        <form action="doc.php" method="POST" style="display: flex; flex-direction: column; margin: 50px 20%;">

        <label for="patient_fname" style="margin:100px,0;">Doctor first name: </label>
        ...
        <label for="patient_lname" style="margin:100px,0;">Doctor last name: </label>
        ...
        <label for="date_of_birth" style="margin:100px,0;">Age: </label>
        <input type="number" name="dob" style="margin:100px,0; height:150px;" value="<?php echo htmlspecialchars($dob);?>">
        <div class="errormessage" style="color:red; margin:100px,0;"><?php echo($errors['birth']);  ?></div>

        <label for="patient_email" style="margin:100px,0;">Doctor email: </label>
        ...
        <label for="Create a password" style="margin:100px,0;">Doctor Password: </label>
        ...
        <label for="patient_phone" style="margin:100px,0;">Doctor phone number: </label>
